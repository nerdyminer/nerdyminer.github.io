---
title: "El problema de pit final"
...
- **<font color='mediumorchid'>Numpy</font>**, para construir nuestro inventario de bloques en la forma de un arreglo 2D (con filas y columnas). Por cierto, en este repositorio AMAMOS usar **<font color='mediumorchid'>Numpy</font>**. Es una de mis librerías favoritas (de hecho, es la primera que aprendí a utilizar después de MESES de tutoriales y sesiones de estudio).
- **<font color='mediumorchid'>Matplotlib</font>**, para graficar nuestros resultados.
- **<font color='mediumorchid'>NetworkX</font>**, para formular el problema como un grafo e implementar el algoritmo de máximo flujo para resolverlo. Esta librería es increíblemente útil para formular y resolver todo tipo de problemas por medio de grafos. Recomiendo, a quienes no la tienen en su caja de herramientas, que le den una oportunidad.
...
### Solución por medio de <font color='mediumorchid'>NetworkX</font>.
...
Finalmente, usamos **<font color='mediumorchid'>Matplotlib</font>** para visualizar nuestro pit final:
...
- El resultado final (los pits anidados) se mostrará en una animación realizada en **<font color='mediumorchid'>Matplotlib</font>**.
