...
::: {.class-keywords}
[Modelos de ensamble]{.class-keyword}
[Voting]{.class-keyword}
[Bagging]{.class-keyword}
[Bootstrap]{.class-keyword}
[Random forest]{.class-keyword}
[Boosting]{.class-keyword}
[AdaBoost]{.class-keyword}
[Gradient boosting]{.class-keyword}
[XGBoost]{.class-keyword}
...
#| fig-cap: "Mapa de calidad para las variables del caso de molienda SAG."
...
#| fig-cap: "Evolución temporal y promedio móvil de la presión de alimentación de las baterías de hidrociclones en el circuito SAG."
fig, ax = plt.subplots(figsize=(9, 4))
...
#| fig-cap: "Comparación de desempeño entre modelos de regresión individuales."
...
#| fig-cap: "Resultados de la búsqueda de hiperparámetros y su comparación entre una máquina de soporte vectorial y un ensamble construido por medio de un procedimiento de bagging."
...
#| fig-cap: "Fronteras de decisión generadas por distintos tipos de ensambles frente a la generada por un modelo de árbol de decisión."
...
#| fig-cap: "Intervalos de predicción estimados mediante gradient boosting por cuantiles."
...
#| fig-cap: "Efecto de la búsqueda de hiperparámetros en nuestro modelo de regresión por cuantiles."
# Visualizamos nuestros resultados.
fig, ax = plt.subplots(figsize=(9, 5))
ax.plot(
    X_val,
