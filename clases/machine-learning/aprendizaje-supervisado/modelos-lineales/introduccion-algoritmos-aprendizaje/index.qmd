...
**<font color='blue'>Definición 1.1 – Algoritmo de aprendizaje (o algoritmo de *machine learning*):</font>** Decimos que un programa de computadora *aprende* desde la experiencia $E$, con respecto a algún conjunto de tareas o problemas $T$ y una determinada métrica de rendimiento $P$, si su desempeño en las tareas de $T$, medido por $P$, mejora con la experiencia $E$.
