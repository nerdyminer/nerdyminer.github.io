...
Donde $\left| x_{i}\right|$ es el valor absoluto de la *componente* $x_{i}$. En la Fig. @fig-normas (a) se muestran todos los puntos en el plano $\mathbb{R}^{2}$ tales que $\left\Vert \mathbf{x} \right\Vert_{1}  =1$. ◼︎
