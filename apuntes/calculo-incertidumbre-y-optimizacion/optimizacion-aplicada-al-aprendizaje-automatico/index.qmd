...
ax.set_title("Conjunto de datos de ejemplo", fontsize=13, fontweight="bold", pad=10)
...
ax.set_title("Modelo conforme algoritmo BGD", fontsize=13, fontweight="bold", pad=10)
ax.set_xlabel(r"$x$", fontsize=12, labelpad=10)
ax.set_ylabel(r"$y$", fontsize=12, labelpad=15, rotation=0)
...
```{python}
# Creamos la figura y graficamos los puntos a partir de los cuales entrenamos el modelo.
fig, ax = plt.subplots(figsize=(9, 5))
ax.scatter(x=X, y=Y, color="firebrick", label="Conjunto de datos")

# Mediante un loop sencillo, obtenemos algunas valores de `w` para la trayectoria completa
# del algoritmo.
for k in range(0, len(path_bgd), 100):
    Y_pred_k = x_biased @ path_bgd[k]
    ax.plot(x_range.reshape(-1,), Y_pred_k.reshape(-1,), color="navy", alpha=0.15)

# Completamos el gráfico.
ax.plot(x_range.reshape(-1,), Y_pred_bgd.reshape(-1,), color="navy", label=r"Modelo: $y=w_{0}+w_{1}x$")
ax.set_title("Convergencia del algoritmo BGD", fontsize=13, fontweight="bold", pad=10)
ax.set_xlabel(r"$x$", fontsize=12, labelpad=10)
ax.set_ylabel(r"$y$", fontsize=12, labelpad=15, rotation=0)
ax.legend(loc="upper left", fontsize=10, frameon=True)
plt.tight_layout()
...
fig, ax = plt.subplots(figsize=(9, 5))
ax.scatter(x=X, y=Y, color="firebrick", label="Conjunto de datos")
ax.plot(x_range, Y_pred_bgd.reshape(-1,), color="navy", label=r"Modelo vía BGD", alpha=0.6)
ax.plot(x_range, Y_pred_sgd.reshape(-1,), color="teal", label=r"Modelo vía SGD", alpha=0.6)
ax.set_title("Modelos conforme algoritmos SGD y BGD", fontsize=13, fontweight="bold", pad=10)
ax.set_xlabel(r"$x$", fontsize=12, labelpad=10)
ax.set_ylabel(r"$y$", fontsize=12, labelpad=15, rotation=0)
ax.legend(loc="upper left", fontsize=10, frameon=True)
plt.tight_layout()
...
ax.plot(x_range, Y_pred_bgd.reshape(-1,), color="navy", label=r"Modelo vía BGD", alpha=0.6)
ax.plot(x_range, Y_pred_sgd.reshape(-1,), color="teal", label=r"Modelo vía SGD", alpha=0.6)
ax.plot(x_range, Y_pred_mbgd.reshape(-1,), color="dodgerblue", label=r"Modelo vía MBGD", alpha=0.6)
ax.set_title("Modelos conforme algoritmos SGD, BGD y MBGD", fontsize=13, fontweight="bold", pad=10)
ax.set_xlabel(r"$x$", fontsize=12, labelpad=10)
ax.set_ylabel(r"$y$", fontsize=12, labelpad=15, rotation=0)
ax.legend(loc="upper left", fontsize=10, frameon=True)
plt.tight_layout()
...
fig, ax = plt.subplots(figsize=(9, 5))
ax.plot(path_bgd[:, 0], path_bgd[:, 1], marker="^", color="navy", linestyle="-", alpha=0.6, label="BGD")
ax.plot(path_sgd[:, 0], path_sgd[:, 1], marker="o", color="firebrick", linestyle="-", alpha=0.6, label="SGD")
ax.plot(path_mbgd[:, 0], path_mbgd[:, 1], marker="+", color="gold", linestyle="-", alpha=0.6, label="MBGD")
ax.set_xlabel(r"$w_{0}$", fontsize=12, labelpad=10)
ax.set_ylabel(r"$w_{1}$", fontsize=12, rotation=0, labelpad=15)

ax.set_title(
    "Trayectorias de los algoritmos de GD en el espacio de parámetros",
    fontsize=13, fontweight="bold", pad=10
)

ax.annotate(
    "Solución óptima", xy=(2, 3), xytext=(1, 2.5), xycoords='data',
...
ax.set_title(
    "Datos simulados desde un paraboloide hiperbólico",
    fontsize=13,
    fontweight="bold",
    pad=10
)
...
ax.set_title(
    "Evolución de la función de pérdida durante el entrenamiento con AdaGrad",
    fontsize=13,
    fontweight="bold",
    pad=10
)
...
ax.set_title(
    "Tasas de aprendizaje efectivas en AdaGrad",
    fontsize=13,
    fontweight="bold",
    pad=10
)
...
ax.set_title(
    "Reconstrucción del paraboloide hiperbólico mediante AdaGrad",
    fontsize=13,
    fontweight="bold",
    pad=10
)
...
ax.set_title(
    "Evolución de la pérdida durante el entrenamiento con RMSProp",
    fontsize=13,
    fontweight="bold",
    pad=10
)
...
sample_idx_rmsprop = rng_rmsprop.choice(len(y_rmsprop), size=450, replace=False)
...
ax.set_title(
    "Reconstrucción del paraboloide hiperbólico mediante RMSProp",
    fontsize=13,
    fontweight="bold",
    pad=10
)
...
ax.set_title(
    "Evolución de la pérdida durante el entrenamiento con Adam",
    fontsize=13,
    fontweight="bold",
    pad=10
)
...
ax.set_title(
    "Tasas de aprendizaje efectivas en Adam",
    fontsize=13,
    fontweight="bold",
    pad=10
)
...
ax.set_title(
    "Primer momento corregido en Adam",
    fontsize=13,
    fontweight="bold",
    pad=10
)
...
ax.set_title(
    "Reconstrucción del paraboloide hiperbólico mediante Adam",
    fontsize=13,
    fontweight="bold",
    pad=10
)
...
ax.set_title(
    "Evolución de la pérdida durante el entrenamiento con Nesterov",
    fontsize=13,
    fontweight="bold",
    pad=10
)
...
ax.set_title(
    "Norma de la velocidad durante el entrenamiento con Nesterov",
    fontsize=13,
    fontweight="bold",
    pad=10
)
...
ax.plot(u_arr, H_eval(u=u_arr), color="indianred", label="Entropía")
ax.plot(u_arr, line, color="navy", linestyle="--", label=r"Recta entre $u_{1}$ y $u_{2}$")
ax.scatter(x=0.2, y=H_eval(0.2), color="k")
ax.scatter(x=0.8, y=H_eval(0.8), color="k")

ax.set_title("La entropía es una función cóncava", fontsize=14, fontweight="bold", pad=10)
...
p = ax.contourf(X1, X2, Z, levels=20, cmap="cool", alpha=0.3)
...
ax.fill_between(
    x1_range, upper_bound, lower_bound,
...
ax.set_xlim(0, 16)
ax.set_ylim(0, 12)
ax.set_title("Espacio de soluciones factibles del PL", fontsize=15, fontweight="bold", pad=10)
plt.tight_layout()
```
...
ax.set_title(
    "Separación lineal de margen máximo vía programa cuadrático",
    fontsize=13,
    fontweight="bold",
    pad=10
)
...
ax.set_title(
    "Conjugada convexa de una función cuadrática",
    fontsize=13,
    fontweight="bold",
    pad=10
)
...
ax.set_title(
    r"Conjugada de $f(x)=\alpha x^2/2$",
    fontsize=13,
    fontweight="bold",
    pad=10
)
