...
ax.set_title(
    "Instancia euclidiana del TSP con 60 ciudades",
...
ax.set_title(
    "Convergencia del algoritmo evolutivo",
    fontsize=13, fontweight="bold", pad=10,
)
...
![](media/tsp_evolutivo_n20.gif){fig-align="center" width="100%"}
...
ax.set_title(
    "Instancia tridimensional del TSP",
    fontsize=14, fontweight="bold", pad=10
)
ax.set_xlabel(r"$x$", fontsize=12, labelpad=10)
ax.set_ylabel(r"$y$", fontsize=12, labelpad=10)
...
# Elementos estéticos.
ax.set_title(
    "Trayectoria del mejor punto global en PSO",
    fontsize=14, fontweight="bold", pad=10
)
ax.set_xlabel(r"$x$", fontsize=12, labelpad=10)
ax.set_ylabel(r"$y$", fontsize=12, labelpad=10)
...
ax.set_title(
    "Convergencia del algoritmo PSO sobre la función de Ackley",
    fontsize=14, fontweight="bold", pad=10
)
...
![](media/pso_ackley_2d.gif){fig-align="center" width="100%"}
...
ax.set_zlabel(r"$z$", fontsize=12, labelpad=10)
ax.set_title(
    'La "caja" de huevos en 3D', fontsize=14, fontweight="bold", pad=10,
)
ax.view_init(35, 20)
plt.tight_layout()
```
...
ax.set_title("La 'caja de huevos' en 2D", fontsize=14, fontweight="bold", pad=10)
ax.set_xlabel(r"$x$", fontsize=12, labelpad=10)
ax.set_ylabel(r"$y$", fontsize=12, labelpad=10)
cb = plt.colorbar(p)
cb.set_label(r"Valor de $f(x,y)$", fontsize=12, labelpad=10)
...
ax.set_title(
    "Convergencia del algoritmo PSO sobre la 'caja de huevos",
    fontsize=14, fontweight="bold", pad=10
)
ax.set_xlabel("Número de iteraciones", fontsize=12, labelpad=10)
ax.set_ylabel(r"Mejor valor encontrado de $f(x,y)$", fontsize=12, labelpad=10)
...
![](media/pso_eggholder_2d.gif){fig-align="center" width="100%"}
...
ax.set_title(
    "Convergencia del algoritmo ACO",
    fontsize=14, fontweight="bold", pad=10,
)
ax.set_xlabel("Número de iteraciones", fontsize=12, labelpad=10)
ax.set_ylabel("Longitud de la ruta", fontsize=12, labelpad=10)
...
ax.set_title(
    "Asignación entera sugerida de camiones por unidad de carguío",
    fontsize=13, fontweight="bold", pad=10
)
