...
En todo el período fuera de muestra, el tratamiento contextual medio fue de aproximadamente 6508 tph, mientras que el tratamiento observado promedió cerca de 6472 tph. La diferencia entre estos valores es el residuo operacional, que fue de, aproximadamente, −18 tph. Esta diferencia negativa indica que el modelo subestimó el tratamiento observado en promedio durante el período evaluado por un margen muy pequeño, siendo éste el sesgo neto de la predicción fuera de muestra. La consistencia entre el residuo agregado y el sesgo neto reportado en validación es una prueba útil de que la reportería no alteró el universo, la agregación o el signo del tratamiento.
...
```json
{
  ...
  "metrics": {
    "policy": "rolling_12m",
    "n_days": 169,
    "rmse": 297.9924785170237,
    "mae": 239.99937037724905,
    "bias_pred_minus_actual": 18.46850061462077,
    "mean_interval_90_coverage_pct": 33.72781065088758,
    "predictive_interval_90_coverage_pct": 91.71597633136096,
    "n_divergences": 0
  }
}
```
